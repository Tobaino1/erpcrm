...
namespace erpcrm
{
    public partial class Form11 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=erp_crm");
            con.Open();
            MySqlCommand cmd = new MySqlCommand("INSERT INTO salesrep (`fname`, `phone`, `address`, `username`, `password`) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "', '" + textBox4.Text + "')", con);
            cmd.ExecuteNonQuery();
