...
namespace erpcrm
{
    public partial class Form11 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=erp_crm");
            con.Open();
            MySqlCommand cmd = new MySqlCommand("UPDATE `salesrep` SET `fname`= '" + textBox1.Text + "',`phone`= '" + textBox2.Text + "',`address`= '" + textBox3.Text + "',`username`= '" + textBox4.Text + "',`password`= '" + textBox5.Text + "' WHERE phone_no = '" + textBox2.Text + "'", con);
            cmd.ExecuteNonQuery();
